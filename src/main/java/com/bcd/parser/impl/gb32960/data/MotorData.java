...
public class MotorData {
    ...
    //驱动电机转矩
    @PacketField(index = 5,len = 2,valExpr = "x*0.1-2000",valExprPrecision = 1)
    ...
    //电机控制器输入电压
    @PacketField(index = 7,len = 2,valExpr = "x*0.1",valExprPrecision = 1)
    float inputVoltage;

    //电机控制器直流母线电流
    @PacketField(index = 8,len = 2,valExpr = "x*0.1-1000",valExprPrecision = 1)
    float current;

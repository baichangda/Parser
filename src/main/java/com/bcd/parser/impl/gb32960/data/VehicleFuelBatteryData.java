...
public class VehicleFuelBatteryData {
    //燃料电池电压
    @PacketField(index = 1,len = 2,valExpr = "0.1*x", valPrecision = 1)
    float voltage;
    ...
    //燃料消耗率
    @PacketField(index = 3,len = 2,valExpr = "0.01*x", valPrecision = 2)
    ...
    //氢系统中最高温度
    @PacketField(index = 6,len = 2,valExpr = "0.1*x-40", valPrecision = 1)
    ...
    //氢气最高压力
    @PacketField(index = 10,len = 2,valExpr = "0.1*x", valPrecision = 1)
    float maxPressure;
